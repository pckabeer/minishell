...
/*
    ...
    len_quote is the length of the quote used for >> or << redirection it will be 1 else for all it is 0
    cmd_seq is the command sequence number for the command 0 for no command 
        1 for first command 2 for second command and so on till command 7 for exit
        after 7 the program will check if the command is there in the system  and then execute it or give an error
